...
xfilenames=strcat('/data2/seismometer/',cell2mat(month(times,'name')),num2str(day(times)),'/',xfiles);
yfilenames=strcat('/data2/seismometer/',cell2mat(month(times,'name')),num2str(day(times)),'/',yfiles);
zfilenames=strcat('/data2/seismometer/',cell2mat(month(times,'name')),num2str(day(times)),'/',zfiles);
